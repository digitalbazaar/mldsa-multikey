...
import {MULTIBASE_BASE64URL_HEADER} from './constants.js';
import {
...
export function publicKeyMultibaseToMultihashKeyId({publicKeyMultibase}) {
  ...
  return publicKeyBytesToMultihashKeyId({publicKeyBytes});
}
